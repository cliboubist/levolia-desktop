...
<body>
<main>
  <div class="brand">Levolia<span class="dot"></span>Agents</div>
  <div class="card">
    <h1>Connexion</h1>
    <p class="subtitle">Identifiez-vous pour accéder à votre agent Levolia.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Connexion indisponible — Levolia</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
